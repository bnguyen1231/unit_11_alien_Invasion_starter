...
class AlienFleet:
    ...
    def create_fleet(self):
        ...
        #self._create_checkered_fleet(alien_w, alien_h, fleet_w, fleet_h, x_offset, y_offset)
        #self._create_grid_shaped_fleet(alien_w, alien_h, fleet_w, fleet_h, x_offset, y_offset)
    ...
    def _create_grid_shaped_fleet(self, alien_w, alien_h, fleet_w, fleet_h, x_offset, y_offset):
        for row in range(fleet_h):
            for col in range(fleet_w):
                current_x = alien_w * col + x_offset
                current_y = alien_h * row  + y_offset
